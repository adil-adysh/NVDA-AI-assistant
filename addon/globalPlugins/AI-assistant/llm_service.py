...
from .models import ChatMessage, LLMResponse, ProgressEvent, ProgressHandler, SummaryResponse
from .providers.base import LLMProvider, PartialCallback, ProgressCallback
...
class ProviderLLMService:
    ...
    def _convert_tool_messages(self, tool_messages: list["ChatMessage"]) -> list[Message]:
        from .core.canonical import Part
