...
from ..context.extractors.excel import ExcelAwarePageExtractor
...
def build_plugin_services() -> PluginServices:
	...
	page_extractor = ExcelAwarePageExtractor(nvda_context_provider=nvda_context_service)
	...
	return PluginServices(
		...
		nvda_context_service=nvda_context_service,
