export const defaultLocalizedStrings = {
    app_brand: 'NVDA AI Assistant',
    app_title: 'Response Workspace',
    ...
    response_subtitle: 'Response',
    prompt_subtitle: 'Prompt',
    session_controls_label: 'Session controls',
    content_actions_label: 'Content actions',
