...
impl UiCommand {
	...
	fn from_legacy_action(action: &str, payload: Value) -> Result<Self, ProtocolError> {
		match action {
			...
			_ => Err(ProtocolError::new(
				ProtocolErrorKind::UnsupportedCommand,
				None,
	...
	fn from_command_name(name: CommandName, payload: Value) -> Self {
		match name {
